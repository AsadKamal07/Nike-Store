    ...
    <section className="max-container flex flex-wrap items-center max-xl:flex-col-reverse gap-10">
     ...
     <div className="flex flex-1 flex-col">
        <h2 className="font-palanquin text-4xl font-bold capitalize lg:max-w-lg">
          <span className="text-coral-red pr-3">Special</span>
          Offer
        </h2>
       <p className="info-text lg:max-w-lg mt-4">Embark on a shopping journey that redefines your experience with unbeatable deals. From premier selections to incredible savings, we offer unparalleled value that sets us apart.</p>
